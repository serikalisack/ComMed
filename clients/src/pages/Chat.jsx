            ...
            <div className='border-[1px] border-[#FFD700] px-6 py-3 w-[360px] sm:w-[400px] md:w-[350px] lg:w-[400px] rounded-t-[10px] bg-[#1a1d24] flex items-center gap-x-2'>
              ...
              <form onKeyDown={(e) => keyDownFunction(e)} onSubmit={(e) => e.preventDefault()} className='flex-1'>
                <input
                  ...
                  className='focus:outline-0 w-[100%] bg-[#1a1d24] text-[#f0f0f0]'
                  type="text"
                  name="message"
        ...
        <div className={props.className}>
          <div className='relative'>
            <div className='absolute top-[40vh] left-[44%] flex flex-col items-center justify-center gap-y-3'>
              ...
              />
              <h3 className='text-[#FFD700] text-[20px] font-medium tracking-wider'>
                Welcome <span className='text-[#FFD700] text-[19px] font-bold'>{activeUser.name}</span>
              </h3>
            </div>
          </div>
        </div>
